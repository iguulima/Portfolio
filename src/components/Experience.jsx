  ...
  return (
    <div className="exp-main">
        <div className='exp-title'>
            <button className='btn' style={estiloBtn(experience === 1)} onClick={()=> setExperience(1) }>Profissional</button>
            <button className='btn'style={estiloBtn(experience === 2)} onClick={()=> setExperience(2)}>Educacional</button>
        </div>
        ...
        {experience === 1 ? (
          ...
          <div>
            <div className='exp-scontent'>
              ...
              <ul>
                <li><span>Fundamentos de TI</span> – Arquitetura, sistemas operacionais, lógica de programação</li>
                <li><span>Desenvolvimento de Sistemas</span> – Programação, bancos de dados, web</li>
                <li><span>Infraestrutura e Redes</span> – Administração de redes, computação em nuvem, servidores</li>
                <li><span>Metodologias Ágeis</span> – Scrum, Kanban, PMBOK, ITIL, COBIT e gestão ágil de equipes.</li>
              </ul>
            </div>
          </div>
        )}
